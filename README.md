...
| Name                                                | Does what?                                                                                                   |
| --------------------------------------------------- | :----------------------------------------------------------------------------------------------------------- |
| [rgbToColor](###%20rgbToColor)                         | Converts a three or four value RGB array to a CSS rgb value                                                  |
| [rgbsToColors](###%20rgbsToColors)                     | Converts a map of three or four value RGB arrays to a map of CSS rgb values                                  |
| [rgbNoAlpha](###%20rgbNoAlpha)                         | Removes alpha component of an RGB array                                                                      |
| [renderColorSchemes](###%20renderColorSchemes)         | Creates CSS color scheme media queries from a set of themes; goes hand-in-hand with `generateThemeVariables` |
